...
def  generate_random_word():
    word_list = [
        ...
        "BBBB", "ZAMLLL", "يانقش", "9WAD", "طبونك_مقود",
        "كسك", "انيكمك", "اقعد_يعرص", "اححح", "AAA",
        "ستريمرز_فاشل", "XXXX", "يخول", "ترمتك_غوز", "سوتك_جميله",
        "هههههههههههه", "سوتك_غوز", "يانيكمك", "ابلع_ياعرص", "يا_لبوت",
        "يازبي", "كسك_قوه", "كسك", "انطلق_فكسك", "يافاشل",
        "يازانيه", "ياقلوتي", "كسك", "نشدك_نحوؤك", "سوتك",
        "يافاشل", "نيكمك", "كوسمك", "يكسمك", "هضرب_عشره_عليك", "لحاااااس", " XXX", ""
    ]
...
class FF_CLIENT(threading.Thread):
    ...
    def GenResponsMsg(self, Msg):
        ...
        1: 1,
        2: {
            1: 3965006993,#bot account id
            2: 3080231443,#clan id
            3: 1,
            4: str(Msg),
                ...
                if "8" in parsed_data["5"]["data"] and "data" in parsed_data["5"]["data"]["8"]:
                    ...
                    if uexmojiii == "DefaultMessageWithKey":
                        ...
                        clients.send(
                            self.GenResponsMsg(
                                f"""[C][B]
مرحبًا بكم في كلان [00ff00]MR KUDDUS OFFICIAL[ffffff]!
...
if __name__ == "__main__":
    try:
        client_thread = FF_CLIENT(id="3965006993", password="06DECEC5FAC888C86563C17E63D39F14E9CFA6BFF0250BD3F88D02E280BBA392")
        client_thread.start()
    except Exception as e:
